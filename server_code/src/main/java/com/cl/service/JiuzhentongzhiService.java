...
public interface JiuzhentongzhiService extends IService<JiuzhentongzhiEntity> {
    ...
    PageUtils queryPage(Map<String, Object> params);
   	...
   	void createNotificationsForAppointment(YishengyuyueEntity appointment);
   	...
   	void manualRetry(Long notificationId);
   	
   	void markAsHandled(Long notificationId);
   	
   	List<JiuzhentongzhiEntity> getNotificationsByAppointmentId(Long appointmentId);
